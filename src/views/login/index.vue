  ...
  <div class="app-container">
    <div style="margin-top: 150px">
      ...
      <div v-if="activeName === 'login'" style="width: 20%; margin: auto">
        <el-input v-model="loginForm.username" tabindex="1" clearable style="margin-bottom: 20px" placeholder="输入ldap账号">
          <template slot="prepend">账号</template>
        </el-input>
        <el-input v-model="loginForm.password" tabindex="2" show-password clearable style="margin-bottom: 20px" placeholder="输入ldap密码" @keyup.enter.native="handleLogin">
